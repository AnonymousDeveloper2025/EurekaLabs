...
class ThemedPDF extends FPDF {
    public $theme;
    public $contentMargin = 20; // ✅ CORRIGIDO: lMargin da FPDF é "protected" — não dá para aceder a partir da função renderNode() (fora da classe). Guardamos o nosso próprio valor público, com o mesmo valor passado a SetMargins().
    private $margin = 15;
